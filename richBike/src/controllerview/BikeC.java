...
public class BikeC {
  ...
  public void initialize() {
    ...
    dpDate.disableProperty().bind(hideNonkeyProperty);
  ...
  private void cancel() {
    if (model != null) {
      ...
      dpDate.valueProperty().unbindBidirectional(model.dateProperty());
    }
...
//      tfPreis.textProperty().bindBidirectional(model.preisProperty(), new NullableBigDecimalStringConverter(NUMBERFORMAT_2DECIMALS));
      ...
      dpDate.valueProperty().bindBidirectional(model.dateProperty());
