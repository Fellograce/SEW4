...
public class Bike {
  ...
  public static Bike select(String rahmennr) throws SQLException {
    ...
    if (resultSet.next()) {
      bike = new Bike(resultSet.getString("rahmennr"),
          ...
          (resultSet.getDate("verfuegbar") == null ? null : resultSet.getDate("verfuegbar").toLocalDate()),
  ...
  /**
   * Defaulting und Überprüfung.
   * Wird vor jedem Schreiben auf die Datenbank aufgerufen.
   *
   ...
   * <p>
   * Zunächst wird versucht das Bike einzufügen. Wenn dies wegen einer Primärschlüssel-Violation schiefgeht,
   * wird versucht es abzuändern. (insert-default-update)
   *
   * @throws BikeException
   * @throws SQLException
   */
  public void save() throws BikeException, SQLException {
    ...
    try {
      ...
      pstmt.setDate(3, (getVerfuegbar() == null ? null : java.sql.Date.valueOf(getVerfuegbar())));
      ...
      if (e.getSQLState().equals("23505")) {
        ...
        pstmt.setDate(2, (getVerfuegbar() == null ? null : java.sql.Date.valueOf(getVerfuegbar())));
