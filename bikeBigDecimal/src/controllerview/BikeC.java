...
import model.Bike;
import model.NullableBigDecimalStringConverter;
...
public class BikeC {
    ...
    /**
     * Initialisierung.
     * Wird vom FXML-Loader aufgerufen und dient zum Initialisieren der Controls, dem Einrichten von Bindings, etc.
     */
    @FXML
    ...
    private void cancel() {
        if (model != null) {
            ...
            Bindings.bindBidirectional(tfPreis.textProperty(), model.preisProperty(), decimalStringConverter);
        }
    ...
    private void select() {
        try {
            ...
            Bindings.unbindBidirectional(tfPreis.textProperty(), model.preisProperty());
